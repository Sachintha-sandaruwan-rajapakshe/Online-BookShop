      ...
      <div class="container-fluid">
        ...
        -->
            <section class="sec">
                ...
                <div class ="image">
                            ...
                            <div class ="box3">
                                    ...
                                    <h1 style ="text-align: center;font-size: 37px ; "> User Login  </h1>
                                    <br>
            ...
            <?php
                ...
                {
                    $count=0;
                    $res = mysqli_query($database," SELECT * FROM user  WHERE username='$_POST[username]' && password='$_POST[password]';");
