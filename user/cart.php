                                        ...
                                        <div class="table-responsive">
                                                ...
                                                <?php
                                                    ...
                                                    <tr>
                                                            ...
                                                            <td><a href="cart.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span class="text-danger" style="color:white;text-decaration:none;S">Remove Item</span></a></td>

                                                            <td><a href="buy.php?action=buy&id=<?php echo $value["product_id"]; ?>"><span class="text-danger" > <input class="btn btn-default" type="button" name="buy" value="buy" style="height:40px ;width:100px;color: black; float: center;background-color: red;">  </span></a></td>
                                                    </tr>
                                                    <?php
